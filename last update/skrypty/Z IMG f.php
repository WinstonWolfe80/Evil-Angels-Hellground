...
//		print "\"";
	...
	print "<br>[b]Link do UI:[/b]<br> ";
		print "[img]";
		print $_POST['ui'];
		print "[/img]";
		
	print "<br>[b]Screenshot z ekranu logowania:[/b]<br> ";
		print "[img]";
		print $_POST['alts'];
		print "[/img]";
	...
	print "<br>[b]Jak d&#322;ugo grasz w WoW'a:[/b]  ";
		print $_POST['wowtime'];
	
	print "<br>[b]Attunement'y:[/b]<br>";
	f1("BT attunement: ", $_POST['attu_bt']);
	f1("MH attunement: ", $_POST['attu_mh']);
	
	print "<br>[b]Znajomo&#347;&#263; taktyk (praktyczna):[/b]<br>";
	print "<br>[b]Tier 5:[/b]";
